...
module.exports = async (argv) => {
  program
    ...
    .option('--inject-style <css-style>', 'optional css style', '')
    .option('--puppeteer-options <options>', 'puppeteer options', '')
  ...
  const opts = {
    ...
    inject: {
      style: program.injectStyle
    },
    puppeteerOptions: program.puppeteerOptions
  }
